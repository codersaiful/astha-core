...
class Astha_Testimonial_Box extends Widget_Base{
    ...
    public function get_title() {
        return __( 'Testimonial Box', 'astha' );
    }
    ...
    public function get_custom_help_url() {
            return 'https://example.com/Astha_Testimonial_Box';
    }
    ...
    public function get_icon() {
        return 'astha eicon-testimonial';
    }
...
//            'additional_scripts'       => [
//                'swiper-min' =>    [
//                    'url'               =>  ASTHA_CORE_BASE_URL . '/assets/vendor/js/swiper-min.js',
//                    'dependency'        =>  ['jquery'],
//                    'version'           => false,
//                    'in_footer'         =>  true,
//                ],
//            ],
    ...
    protected function style_subtitle_controls() {
        $this->start_controls_section(
            'subtitle-typography',
            [
                'label'     => esc_html__( 'Position', 'astha' ),
                'tab'       => Controls_Manager::TAB_STYLE,
            ]
        );
